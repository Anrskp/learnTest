...
var appRoutes = [
    ...
    { path: 'dashboard', component: __WEBPACK_IMPORTED_MODULE_10__components_dashboard_dashboard_component__["a" /* DashboardComponent */], pathMatch: 'full', canActivate: [__WEBPACK_IMPORTED_MODULE_15__guards_auth_guard__["a" /* AuthGuard */]] },
    { path: 'profile', component: __WEBPACK_IMPORTED_MODULE_11__components_profile_profile_component__["a" /* ProfileComponent */], pathMatch: 'full', canActivate: [__WEBPACK_IMPORTED_MODULE_15__guards_auth_guard__["a" /* AuthGuard */]] }
];
var AppModule = (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_12__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_13__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_15__guards_auth_guard__["a" /* AuthGuard */], __WEBPACK_IMPORTED_MODULE_16__services_post_service__["a" /* PostService */]],
...
module.exports = "<h2 class=\"page-header\"> Dashboard </h2>\n<p>Welcome to your Dashboard</p>\n\n<div style=\"height: 400px; width: 1200px; overflow: auto; border:2px solid black;\">\n  <div *ngFor=\"let msg of messages\" style=\"background-color: lightblue;\">\n\n    <p> {{ msg.username }} </p>\n    <p> <b> {{ msg.post }} </b> </p>\n    <p> {{ msg.date }} </p>\n\n  </div>\n</div>\n<br>\n<form (submit)=\"onRegisterSubmit()\">\n\n  <div class=\"form-group\">\n    <input type=\"text\" [(ngModel)]=\"msg\" name=\"msg\" class=\"form-control\" >\n  </div>\n\n\n  <input type=\"submit\" class=\"btn btn-primary\" value=\"Submit\">\n</form>\n"
...
var DashboardComponent = (function () {
    function DashboardComponent(socketService, postService) {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        this.postService.getAllPosts().subscribe(function (posts) {
            posts.posts.forEach(function (e) { return _this.messages.unshift(e); });
        }, function (err) {
            console.log(err);
            return false;
        });
    ...
    DashboardComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_1__services_socket_service__["a" /* SocketService */]]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_socket_service__["a" /* SocketService */], __WEBPACK_IMPORTED_MODULE_2__services_post_service__["a" /* PostService */]])
    ], DashboardComponent);
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessage.show('Username already in use', { cssClass: 'alert-danger', timeout: 3000 });
                _this.router.navigate(['/register']);
            }
            else if (data.msg === "email already in use") {
                _this.flashMessage.show('Email already in use', { cssClass: 'alert-danger', timeout: 3000 });
                _this.router.navigate(['/register']);
            }
            else {
...
var SocketService = (function () {
    ...
    SocketService.prototype.getMessages = function () {
        ...
        var observable = new __WEBPACK_IMPORTED_MODULE_0_rxjs_Observable__["Observable"](function (observer) {
            _this.socket.on('receive message', function (data) {
                observer.next(data);
            });
            return function () {
